  ...
  <section class="oddBg">
    ...
    <div v-if="this.semData.length == 0">
      ...
      <p
        ...
        "
      >
        You Dont Have Any Courses In The Sem..
      </p>
    </div>
    <add-course
    ...
    <ul
      ...
      :prerequsite="course.course_prerequsite"
    >
      ...
      <div class="course__data">
        ...
        <div class="course__text">
          ...
          <div class="Instructor">
            ...
            <!-- TO SHOW THE RATING THAT EACH COURSE AS RECIEVED -->
            <base-badge
              mode="highlight"
              :no-margin-left="true"
              class="Instructor"
...
export default {
  components: {
    ...
    TheHeader, //ADD COURSE COMPONENT
    BaseDialog,
  },
  ...
  methods: {
    getCourses() {
      fetch('http://localhost:5000/get/Course/3', {
        method: 'GET',
        headers: {
    ...
    getCoursesTeacher() {
      fetch(
        `http://localhost:5000/get/CourseByLecturer/${this.$store.state.CurrentUser}/3`,
        {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
    ...
    // Gets the rating of each course
    GetAvgRating() {
    ...
    //makes the values of the avg rating form the databaes more accesible
    getvalues() {
    ...
    activateForm() {
      //function which toggles open the form
      this.$store.commit('SetFormActivity', {
        value: true,
      });

      //gets the highest id in 3rd sem
      fetch('http://localhost:5000/get/HighestCourseID3rdSem', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
        },
    ...
    editCourse(
      ...
      //Sets the bool for edit to true
